<template>
  <div>
    <div style="margin: 10px 0">
      <el-input style="width: 200px" placeholder="请输入学生姓名" suffix-icon="el-icon-search" v-model="name"></el-input>
      <el-input style="width: 200px" placeholder="请输入班级名" suffix-icon="el-icon-search" class="ml-5" v-model="clazzName"></el-input>
    ...
    <div style="margin: 10px 0">
      ...
      <el-upload :action="'http://' + serverIp + ':9090/student/import'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
<!--      <el-table-column prop="id" label="ID" width="80"></el-table-column>-->
      <el-table-column prop="id" label="学号" width="90"></el-table-column>
      <el-table-column prop="name" label="姓名" ></el-table-column>
      <el-table-column prop="major" label="专业" ></el-table-column>
      <el-table-column prop="clazz" label="班级" width="90"></el-table-column>
...
<!--        </el-form-item>-->
        ...
        <el-form-item label="班级">
          <el-select clearable v-model="form.clazzId" placeholder="请选择">
            <!--label:显示的名字  value:存的值-->
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open(`http://${serverIp}:9090/student/export`)
    },
