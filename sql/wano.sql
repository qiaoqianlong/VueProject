...
-- Records of article
-- ----------------------------
INSERT INTO `article` VALUES (1, '万季玲的文章标题', '# 我是万季玲\n## 我是万季玲2号\n\n::: hljs-center\n\n***++~~==我是那个毛毛==~~++***\n\n:::\n\n> 我是毛毛的引用\n\n\n[这是百度的链接](https://www.baidu.com)\n\n```java\nclass Hello {\n  public static void main(String[] args) {\n    System.out.pringln(\"Hello 毛毛\");\n  }\n}\n\n```\n\n\n', '毛毛', '2022-03-22 19:22:58');
INSERT INTO `article` VALUES (2, '万季玲文章2号', '这是文章内容部分\n\n![1.jpg](1)\n![3.jpg](1)', '毛毛', '2022-03-22 19:22:58');
...
INSERT INTO `sys_file` VALUES (44, '1.jpg', 'jpg', 7, 'http://localhost:9090/file/009bd990066542848de5347a88af32f3.jpg', '9f133b8ef33d0af8d9e849ad3b449c4c', 0, 1);
INSERT INTO `sys_file` VALUES (45, '3.jpg', 'jpg', 8, 'http://localhost:9090/file/b7b8c4478b4d41e48de0dfc616b3fecc.jpg', 'bae43adeadb9aa1a41e1f82293eac277', 0, 1);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', 'admin', '管理员', 'admin@qq.com', '13988997788', '安徽合肥1', '2022-01-22 21:10:27', 'http://localhost:9090/file/8d966b0e6cf84fe191a72a58b8293b23.png', 'ROLE_ADMIN');
INSERT INTO `sys_user` VALUES (16, '222', '123', '张三', '2', '2', '2', '2022-02-26 22:10:14', NULL, 'ROLE_TEACHER');
INSERT INTO `sys_user` VALUES (17, '333', '123', '李四', '3', '3', '3', '2022-02-26 22:10:18', 'http://localhost:9090/file/7737484487db47ab89e58504ddf86ac1.jpg', 'ROLE_TEACHER');
INSERT INTO `sys_user` VALUES (18, 'nzz', '123', '王五', '2', '2', '2', '2022-03-29 16:59:44', '', 'ROLE_STUDENT');
INSERT INTO `sys_user` VALUES (19, 'yss', '123', '赵六', '3', '3', '3', '2022-04-29 16:59:44', '', 'ROLE_STUDENT');
INSERT INTO `sys_user` VALUES (20, 'lxx', '123', '李信', '2', '2', '2', '2022-05-29 17:12:04', '2', 'ROLE_STUDENT');
INSERT INTO `sys_user` VALUES (25, 'sir', '123', '杨老师', NULL, NULL, NULL, '2022-06-08 17:00:47', NULL, 'ROLE_STUDENT');
INSERT INTO `sys_user` VALUES (26, 'err', NULL, '李老师', '11', '1', '1', '2022-07-08 17:20:01', NULL, 'ROLE_STUDENT');
...
INSERT INTO `t_comment` VALUES (11, '像我这样的人', 16, '2022-03-22 21:38:26', 10, 4, 1);
INSERT INTO `t_comment` VALUES (13, '怎么灿烂过一生', 28, '2022-03-22 21:46:01', 12, 12, 1);
INSERT INTO `t_comment` VALUES (14, '二十多年到头来', 20, '2022-03-22 21:46:48', 13, 12, 1);
INSERT INTO `t_comment` VALUES (15, '还在人海里沉浮', 20, '2022-03-22 21:47:03', 13, 12, 1);
INSERT INTO `t_comment` VALUES (16, '借', 20, '2022-03-22 21:48:19', 4, 4, 1);
INSERT INTO `t_comment` VALUES (17, '33333', 20, '2022-03-22 21:48:42', 5, 5, 1);
INSERT INTO `t_comment` VALUES (19, '一道彩虹两个人', 20, '2022-03-22 21:49:21', 1, 1, 1);
